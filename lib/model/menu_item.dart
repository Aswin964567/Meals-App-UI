...
List<MenuItems> menuItems = [
  const MenuItems(title: 'Soups', imagePath: 'assets/menu.png'),
  const MenuItems(title: 'Starters', imagePath: 'assets/menu.png'),
  const MenuItems(title: 'Combo Meals', imagePath: 'assets/menu.png'),
  const MenuItems(title: 'Jumbo Meals', imagePath: 'assets/menu.png'),
